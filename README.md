...
### Dataset generated in *"‘To be, or not to be, that is the Question’: Exploring the ‘pseudorandom’ generation of texts to write Hamlet from the perspective of the ‘Infinite Monkey Theorem’"*, available at [arXiv:2402.05867](https://arxiv.org/abs/2402.05867) and at [math.paperswithcode](https://math.paperswithcode.com/paper/exploring-pseudorandom-value-addition).
